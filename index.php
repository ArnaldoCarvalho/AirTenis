...
<head>
  ...
  <link href="<?php echo $arrConfig['url_site'].'/assets/css/layout.css' ?>" rel="stylesheet" type="text/css" media="all">
</head>
...
<body id="top" class="is-preload">
  ...
  <div id="sidebar" class = "inactive">
    <div class="inner">
      <?php
      include($arrConfig['dir_site'] . '/includes/Slidebar/Slidebar.php');
      ?>
    </div>
  </div>

  <!-- Scripts -->
  <script src="<?php echo $arrConfig['url_site']."/assets/js/jquery.min.js"?>"></script>
  <script src="<?php echo $arrConfig['url_site']."/assets/js/browser.min.js"?>"></script>
  <script src="<?php echo $arrConfig['url_site']."/assets/js/breakpoints.min.js"?>"></script>
  <script src="<?php echo $arrConfig['url_site']."/assets/js/util.js"?>"></script>
  ...
  <div class="bgded overlay" style="background-image:url('images/demo/backgrounds/01.png');">
    <div id="pageintro" class="hoc clear">
      <!-- ################################################################################################ -->
      <article>
        <h3 class="heading tc"><span class="">Bem Vindo!</span> <br> <span>AirTénis</span>  </h3>  
        <p>O Futuro do ténis está nas nossas mãos.</p>
        <p>Aqui poderá encontrar: Cortes para reservar, Uma página de Notícias, Uma Loja online, Clubes, etc...</p>

        <footer><a class="btn" href="#">Venha saber mais</a></footer>
      </article>
      <!-- ################################################################################################ -->
    </div>
  </div>
